...
class ProductsController extends GetxController {
  ...
  RxList<ProductCardModel> allProducts = <ProductCardModel>[].obs;
  ...
  void fillterByCategory(String category){
    filteredProducts.value = allProducts.where((e)=>e.category == category).toList();
  }
